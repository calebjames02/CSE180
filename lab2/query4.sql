...
WHERE c.checkInTime <> NULL AND r.seatClass = 'F' AND DATE_TRUNC('day', c.checkInTime) >= '2024-01-12' AND a.city LIKE '%en%' AND c.bagCount >= 2 AND r.paymentMethod IS NOT NULL
